...
class Feed extends Component {
  ...
  finishEditHandler = postData => {
    ...
    // equivalent to enctype="multipart/form-data"
    // we need it for images
    ...
    // call a classic rest api endpoint to store image and return the url
    fetch('http://localhost:8080/post-image', {
      ...
      .then(resData => {
        ...
        // we do this cuz imageUrl is mandatory in ou schema
